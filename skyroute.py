...
stations_under_construction= ['Columbia', 'Burrard', 'Bridgeport', 'King Edward']
...
# Request an endpoint from the user
def get_end():
...
def get_route(start_point, end_point):
  start_stations= vc_landmarks[start_point] # gets a set of at least one metro station
